...
// $domain_prefix = "mashiro.";
$domain_prefix = "";

// Base URL for all image data
$imgsrc = "http://" . $domain_prefix . "4walled.cc/src/";
$thumbsrc = "http://" . $domain_prefix . "4walled.cc/thumb/";
$linksrc = "http://" . $domain_prefix . "4walled.cc/show-";

// Base URL for all page links
$pagesrc = "http://" . $domain_prefix . "4walled.cc/";
...
function check_var($varname, $expected_values) {
	if (!isset($_GET[$varname])) {
		...
		die("$varname not set to an expected value!'" . htmlspecialchars(print_r($_GET[$varname], TRUE)) ."'");
	}
}
...
function check_var_numeric($varname) {
	if ((!isset($_GET[$varname])) or $_GET[$varname] == "") {
		...
		die("$varname not set to an expected value!'" . htmlspecialchars(print_r($_GET, TRUE)) ."'");
	}
}
...
function get_search_parameters() {
	...
	$valid_resolutions = array("",
		...
		"1680x160", "1600x177", "1600x133", "3840x355", "1920x177", "1920x160", "2048x133",
		"2560x178", "2560x160", "2560x125", "2048x266", "2560x266", "2560x250",
		"3360x320", "3150x188", "3840x375", "5760x533", "1080x56", "2560x237");
