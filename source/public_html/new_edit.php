...
?>
<div id="topbar" style="position: fixed; width: 100%; background-color: #fff; color: #000; margin: 0; clear: both;">
...
<div id="mainImage">
<a href="<?php echo $imgsrc . $imageData["md5"] . "." . $imageData["extension"]; ?>">
    <img alt="<?php echo $imageData["imagename"]; ?>" src="<?php echo $imgsrc . $imageData["md5"] . "." . $imageData["extension"]; ?>" <?php echo imageResize($width, $height, 600); ?> />
</a>
<br style="clear: both;" />
